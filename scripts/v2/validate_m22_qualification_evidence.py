...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.artifact_root is None and any((
        args.training_artifact_root is not None,
        args.executable is not None,
        args.corpus is not None,
    )):
        parser.error(
            "unrecognized arguments: --training-artifact-root/--executable/--corpus "
    ...
    try:
        if args.artifact_root is None:
            ...
            live_inputs = LiveInputManifest.bind(context, {
                "qualification-artifacts": args.artifact_root,
                "training-artifacts": args.training_artifact_root,
                "qualification-executable": args.executable,
