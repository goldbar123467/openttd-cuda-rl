...
class M22FollowupV2EvaluationSourceTests(unittest.TestCase):
    ...
    def fake_run(cls, ordinal: int) -> dict[str, object]:
        return fixture_support.make_run(runner, cls.case(f"followup-v2-case-{ordinal:02d}"), ordinal)

    @classmethod
    def fake_manifest_run(cls, ordinal: int, case: dict[str, object]) -> dict[str, object]:
        return fixture_support.make_run(runner, case, ordinal)

    @classmethod
    def fake_report(cls) -> dict[str, object]:
        return fixture_support.make_report(runner, {
            "case_id_prefix": "followup-v2-case", "private_seed": 698564641,
            "source_file_sha256": "7" * 64,
            "report": {
                "artifact_root": "/retained/m22-followup-v2",
                "identity": {
                ...
                "manifest": {
                    "case_count": 42, "id": "m22-independent-followup-v2",
                ...
                "source": {
                    "clean": True, "main_synchronized": True, "repository_commit": "8" * 40,
