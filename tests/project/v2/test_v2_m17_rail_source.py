#!/usr/bin/env python3
"""Mutation tests for the native M17 rail source delta."""
...
class M17RailSourceTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.artifact = pathlib.Path("/home/thecl/.codex/artifacts/openttd-rl/v2-m17-rail-a")
        cls.base = pathlib.Path("/home/thecl/.codex/artifacts/openttd-rl/v2-m16-cargo-a/source")
    ...
    def mutation_fails(self, value: object, pattern: str | None = None, *, live: bool = False) -> None:
        with tempfile.TemporaryDirectory() as raw:
            context = self.assertRaisesRegex(validator.M17SourceError, pattern) if pattern else self.assertRaises(validator.M17SourceError)
            with context:
