...
class M19AirSourceTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.artifact = pathlib.Path("/home/thecl/.codex/artifacts/openttd-rl/v2-m19-air-a")
        cls.base = pathlib.Path("/home/thecl/.codex/artifacts/openttd-rl/v2-m18-ship-a/source")
