...
## Current iteration: sampling variability of fixed models

v2-roll64-sampling-variation-01 is evaluating the frozen 2,048/4,096-decision
...
18 cases. Hypothesis: the sampled regression may depend on action randomness.
All twelve new cases run regardless of interim outcomes, with at most two jobs.
...
This suggests a feature-scale hypothesis, not an established defect. No
preprocessing, checkpoint identity, or frozen encoder has been changed.
